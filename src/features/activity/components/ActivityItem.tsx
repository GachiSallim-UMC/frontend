...
type ActivityItemProps = Pick<ActivityLog, 'description' | 'createdAt' | 'route' | 'user'> & {
...
export const ActivityItem: FC<ActivityItemProps> = ({ description, createdAt, route, user, isLast = false }) => {
  const content = (
    <>
      <p className="text-caption text-gray-900">
        {user.nickname}님이 {description ?? '새로운 활동이 있습니다.'}
      </p>
