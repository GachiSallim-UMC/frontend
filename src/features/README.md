...
각 도메인은 독립적인 비즈니스 단위입니다. 아래 구조를 따라 구현합니다.
...
|--------|------|------|
| `auth` | 01 로그인 | 소리 / 오소윤 |
| `dashboard` | 06 대시보드 | 소리 / 오소윤 |
| `chore` | 07·08 집안일 | 루피 / 오성이 |
| `expense` | 09·10 생활비 정산 | 하루 / 박금별 |
| `item` | 11·12 공용 물품 | 천월 / 임석현 |
| `rule` | 13·14 생활 규칙 | 천월 / 임석현 |
| `messenger` | 15 메신저 | 주노 / 조혜인 |
| `notification` | 16 알림 | 주노 / 조혜인 |
| `activity` | 17 활동 내역 | 주노 / 조혜인 |
| `member` | 18 마이페이지·그룹 | 소리 / 오소윤 |
