...
export const InvitationCodeBox = ({
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-lg border border-dashed border-primary-300 bg-primary-50 pt-6 pb-5">
      {!isCreated ? (
        <>
          <p className="text-sm font-bold text-gray-800">그룹 생성 후 초대 코드가 발급됩니다</p>
        ...
        <>
          <p className="text-sm font-bold text-gray-800">초대 코드</p>
          ...
          <p className="mt-4 text-xs text-gray-600">멤버에게 코드를 공유해 초대하세요</p>
        </>
      )}
    </div>
  );
