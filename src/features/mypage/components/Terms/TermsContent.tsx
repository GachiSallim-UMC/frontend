import { TERMS_DATA } from "@/features/mypage/constants/Terms";
            ...
            <div className="flex flex-col">
                {TERMS_DATA.map((term, index) => (
                    ...
                    >
                        ...
                        {term.list && (
                            <ol className="list-decimal list-inside break-keep-all text-mobile-label leading-snug font-medium text-gray-600 lg:text-sm">
                        ...
                        {term.bullets && (
                            <ul className="list-disc list-inside break-keep-all text-mobile-label leading-snug font-medium text-gray-600 lg:text-sm">
